...
public class DatosEnemigos {
	...
	private EnemigoPrincipal ornn = new EnemigoPrincipal(20, 200, 33, 50, "Ornn", 1);
	private EnemigoPrincipal shyvana = new EnemigoPrincipal(22, 220, 38, 50, "Shyvana", 2);
	private EnemigoPrincipal leeroy = new EnemigoPrincipal(30, 300, 50, 50, "Leeroy Jenkins", 3);
	private EnemigoPrincipal malzahar = new EnemigoPrincipal(24, 240, 42, 50, "Malzahar", 4);
	private EnemigoPrincipal mordekaiser = new EnemigoPrincipal(26, 260, 45, 50, "Mordekaiser", 5);
