...
public class Kled {
	...
	public Kled(double vida, int defensa, int ataque, int poderHabilidad, String nombre, int recursos,
			double vidaMaxima) {
		super();
		this.vida = vida;
	...
	public String toString() {
		return "Kled [vida=" + vida + ", defensa=" + defensa + ", ataque=" + ataque + ", poderHabilidad="
